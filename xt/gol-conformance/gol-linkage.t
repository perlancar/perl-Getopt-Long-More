...
Getopt::Long::More::Configure ("no_ignore_case");
%lnk = ();
...
@ARGV = qw(-Foo -baR --foo bar);
Getopt::Long::More::Configure ("default","no_ignore_case");
%lnk = ();
my $foo;
...
Getopt::Long::More::Configure ("default","prefix_pattern=--|/|-|\\+","long_prefix_pattern=--|/");
%lnk = ();
my $bar;
...
print (!(exists $lnk{bar})   ? "" : "not ", "ok 28\n");
{
    ...
    @ARGV = qw(/Foo=-baR);
    Getopt::Long::More::Configure ("default","bundling","ignore_case_always",
...

{
    ...
    @ARGV = qw(--foo bar);
    Getopt::Long::More::Configure("default");
...

{
    ...
    my $got = "";
    Getopt::Long::More::Configure("default");
    Getopt::Long::More::Configure("pass_through");
...

{
    ...
    my $got = "";
    Getopt::Long::More::Configure("default");
    Getopt::Long::More::Configure("pass_through","require_order");
    print "not" unless GetOptions
	("here" => sub { $got .= " sub_here"; },
	 "<>" => sub { $got .= " <>=".$_[0]; }, );
    $got .= " remain=".join(',',@ARGV);
